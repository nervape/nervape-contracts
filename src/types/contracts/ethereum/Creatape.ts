...
export interface CreatapeInterface extends utils.Interface {
  functions: {
    ...
    "mint(uint256,uint8,bytes32,bytes32)": FunctionFragment;
...
export interface Creatape extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreatapeInterface;
